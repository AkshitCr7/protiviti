...
def detect_forgery(original_path, edited_path, output_dir, area_threshold=100, use_color=False):
...
if __name__ == "__main__":
    ...
    output_dir = r"C:\Users\akshi\Desktop\IMP\Protiviti\Image Document Evidence Analysis"

    detect_forgery(original_image_path, edited_image_path, output_dir=output_dir, use_color=False)
